...
const Nav = () => {
  ...
  return (
    <div className="fixed z-10 bottom-0 md:sticky md:top-0 w-full bg-white flex justify-between items-center py-2 px-2 md:px-12 text-gray-900 border-t-2 border-gray-300 md:gap-4 md:justify-start md:border-t-0 md:border-b-2">
